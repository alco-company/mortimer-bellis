...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { protocol: "https", host: "mortimer.dev" }
  ...
  config.action_cable.url = "ws://mortimer.dev/cable"
  config.action_cable.allowed_request_origins = [ %r{http://*}, %r{https://*} ]
  # config.hotwire_livereload.listen_paths << Rails.root.join("app/assets/builds")

  config.action_controller.default_url_options = { protocol: "https", host: "mortimer.dev" }
