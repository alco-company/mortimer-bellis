...
Devise.setup do |config|
  ...
  # config.secret_key = "56cbb1538cb387cfdfc16e4dc9f411fc53d8d6e914f40abda360458eaa51301dfa8fa8cb81e58f8f5aca2a204ab1c2b014fdc78feaec211ebc118ea10b682ddc"
  ...
  config.mailer_sender = "info@mortimer.pro"
  ...
  # config.pepper = "fe8c9353506aca7cbff97037eb67ac88282dcdf94e71a04b29a294ebdb65c72b13ce7d6b21ada663e8a6589d223e1b44471c8187b16634b0810affa5740d39aa"
  ...
  APP_ID=$(cat .env | grep MS_AD_ID | cut -d'=' -f2)
  APP_SECRET=$(cat .env | grep MS_AD_SECRET | cut -d'=' -f2)
