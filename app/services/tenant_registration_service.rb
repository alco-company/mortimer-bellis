  ...
  def self.call(tenant)
    if tenant.persisted?
      ...
      if user.valid?
        ...
        Employee.create tenant: tenant, name: I18n.t("employee.me"), pincode: "1234", payroll_employee_ident: "1234", team: team, locale: "da", time_zone: "Europe/Copenhagen"
        PunchClock.create tenant: tenant, name: I18n.t("punch_clocks.employee_device_punch_clock"), location: location
