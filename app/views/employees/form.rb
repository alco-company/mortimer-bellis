class Employees::Form < ApplicationForm
  def view_template(&)
    ...
    row field(:hour_rate_cent).input(class: "mort-form-text")
    row field(:ot1_hour_add_cent).input(class: "mort-form-text")
    row field(:ot2_hour_add_cent).input(class: "mort-form-text")
