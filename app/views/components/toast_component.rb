class ToastComponent < ApplicationComponent
  #
  attr_accessor :msg, :type, :sender, :title

  def initialize(message:, type: "success", sender: "mortimer", title: "")
    @msg = message
    @type = type
    @sender = sender
    @title = title
      ...
      div(class: "p-4") do
        div(class: "flex items-start") do
          ...
          div(class: "ml-3 w-0 flex-1 pt-0.5") do
            p(class: "text-sm font-medium mort-flash-#{type} w-full truncate") { title }
