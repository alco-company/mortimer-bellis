...
class PunchesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post punches_url, params: { punch: { tenant_id: @punch.tenant_id, user_id: @punch.user_id, punch_clock: @punch.punch_clock, punched_at: @punch.punched_at, remote_ip: @punch.remote_ip, state: @punch.state } }
  #   end
  ...
  #   patch punch_url(@punch), params: { punch: { tenant_id: @punch.tenant_id, user_id: @punch.user_id, punch_clock: @punch.punch_clock, punched_at: @punch.punched_at, remote_ip: @punch.remote_ip, state: @punch.state } }
