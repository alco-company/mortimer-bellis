...
class CallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create call" do
    assert_difference("Call.count") do
      post calls_url, params: { call: { direction: @call.direction, phone: @call.phone, tenant_id: @call.tenant_id } }
    end
  ...
  test "should update call" do
    patch call_url(@call), params: { call: { direction: @call.direction, phone: @call.phone, tenant_id: @call.tenant_id } }
